...
var i = 0;
var txt = `ANUBHAV SHARMA.`; /* The text */
...
let finald = () => {
  ...
  bootstrap.style.transition = "all 2s linear";
  // setTimeout(()=>bootstrap.innerHTML = "<p>50%</p>" ,2000);
  }
...
function progressbar(){
  ...
  bootstrap.style.width = "1%";
  bootstrap.style.transition = "none";
  bootstrap.innerHTML = ""
  setTimeout(finald, 5)
...
function testingd(){
  bootstrap.removeEventListener("mouseover",testingd);
  bootstrap.style.width = "1%";
  bootstrap.style.transition = "none";
  bootstrap.innerHTML = "";
  setTimeout(finald, 5);
  setTimeout(()=>bootstrap.addEventListener("mouseover",testingd),2050)
...
bootstrap.addEventListener("mouseover", testingd);